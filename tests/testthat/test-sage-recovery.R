test_that("Correct Noise can recover a completed Sage stage", {
  ...
  expect_match(source_text, "loaded successfully for Correct Noise")
  expect_match(source_text, "Step1_project_init[.]rda")
  expect_match(source_text, "Step3_correct_noise[.]rda")
})
