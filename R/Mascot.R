    ...
    sidebar = bslib::accordion(
      bslib::accordion_panel(
        ...
        shiny::fileInput(
          ...
          label = "Upload Mascot protein results (xlsx, xls, csv, txt or tsv)",
          multiple = FALSE,
...
#'
#' Registers placeholder outputs for the Mascot data-source module until the
...
Mascot_server <- function(id, shared_state = NULL) {
  register_placeholder_analysis_server(id, "Mascot", shared_state)
}
